...
\begin{minipage}[c]{0.4\textwidth}
    \textbf{\Huge \scshape{Samir Salmen}} \\ \vspace{1pt} 
    % \scshape sets small capital letters, remove if desired
    \small{+55 94 99136-2886} \\
    \href{mailto:you@provider.com}{\underline{samir.salmen@usp.br}}\\
    % Be sure to use a professional *personal* email address
    \href{https://github.com/elfoph}{\underline{github.com/elfoph}}
\end{minipage}
...
%      {Institution you worked with}{unused}
     ...
     {By myself}{}
     \CVSubheading
     {EPUB/MOBI conversor | \textit{Python}}{2020-2021}
     {By myself}{}
...
\section{Skills}
 \begin{itemize}[leftmargin=0.5cm, label={}]
    \small{\item{
            ...
            \textbf{Programming}{: Linux, Python, Mathematica, Java, C/C++, git} \\
